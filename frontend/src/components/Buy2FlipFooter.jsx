    ...
    <footer className="footer">
      <div className="footer-container">
        ...
        <div className="footer-about">
          <img
            src="/assets/images/logo/buy2fliplogo.webp"
            alt="Highbridge Homes"
            className="footer-logo"
          />
          <p>
          Buy2Flip: A short-term investment scheme focusing on purchasing assets to later sell for
           profit, ensuring fast and efficient returns.
          </p>
        </div>
